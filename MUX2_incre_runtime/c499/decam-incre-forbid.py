...
class DissectCkt:
    ...
    def initSolve(self, OracIn, CamIn, MuxStyle, forbidFlag):
        ...
        self._genCamCNF(CamIn, MuxStyle, forbidFlag)
    ...
    def findSolu(self, OracPIls, OracPOls, camVarNum, camCNFile,\
        camCBindex, camPIndex, camPOindex, MuxStyle, forbidFlag):   
        ...
        if num2dup-1 > 0:
            ...
            for pbit in range(camCBindex[0], camCBindex[-1], 2):
                soluCBline = '-'+str(pbit)+' -'+str(pbit+1)+' 0\n' 
                tmpCnfLs[0].append(soluCBline)
